...
const AdvancementCards: React.FC = () => {
  const [farms] = useFarms(true)
...
const AdvancementCard: React.FC<AdvancementCardProps> = ({ farm }) => {
...
export default AdvancementCards