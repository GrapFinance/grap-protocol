...
The expectation is that after the pools receive their GRAPs, there is no longer a founding team or any team to speak of. This is a protocol that is being put out there in a decentralized  way, then walk away. The writer of these contracts or those connected with its inception, are under no obligation and likely won't continue development once it is deployed.
...
##### File: `GRAPTokenStorage.sol`
##### Description
address that controls the rebasing functionality. This contract is one of two contracts that can `mint`. It also tells how much to change `grapsScalingFactor`.
##### Setting
###### File: `GRAP.sol`
...
##### File: `GRAPRebaser.sol`
##### Description
The peg the protocol should aim for relative to the reserveToken. i.e. `1e18` means 1:1 between the reserveToken and GRAP.
##### init_value: `1e18`
##### Setting
###### File: `GRAPRebaser.sol`
```
...
##### File: `GRAPRebaser.sol`
##### Description
The amount of GRAP that the rebaser mints that is sold to build the protocol's treasury. Decimals: 18. i.e. 1e17 == .1, or 10% of the rebase.
