...
import "./RUPXDelegate.sol";

contract RUPXDelegator is RUPXTokenInterface, RUPXDelegatorInterface {
    /**
     * @notice Construct a new RUPX
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "RUPXDelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"RUPXDelegator:fallback: cannot send value to fallback");
